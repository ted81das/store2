            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        <h3>{{__('Customer')}} <span> {{__('Register')}} </h3>
                            {!! Form::open(array('route' => array('store.userstore', $slug)), ['method' => 'post']) !!}
                                ...
                                <div class="last-btns">
                                    ...
                                    <p>{{ __('By using the system, you accept the')}} 
                                        <a>  {{__('Privacy Policy')}}</a> {{ __('and') }} <a> {{ __('System Regulations.') }} </a>
                                    </p>
                                </div>
                                <p class="register-btn">{{__('Already registered ?')}}<a href="{{route('customer.loginform',$slug)}}" class="btn">{{__('Login')}}</a></p>
                            {!! Form::close() !!}
                    </div>
                </div>
            </div>
