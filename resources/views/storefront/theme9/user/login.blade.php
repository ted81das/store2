            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="login-form">
                        <h3>{{__('Customer')}} <span> {{__('login')}}</h3>
                            {!! Form::open(array('route' => array('customer.login', $slug,(!empty($is_cart) && $is_cart==true)?$is_cart:false)),['method'=>'POST']) !!}
                                ...
                                <div class="last-btns">
                                    <button type="submit" class="login-btn ">{{__('Sign In')}}</button>
                                    <p>{{__('By using the system, you accept the')}} 
                                        <a href=""> {{__('Privacy Policy')}}  </a> {{__('and')}} <a href=""> {{__('System Regulations')}}. </a>
                                    </p>
                                </div>
                            {!! Form::close() !!}
                            <p class="register-btn">{{__('Dont have account ?')}}<a href="{{route('store.usercreate',$slug)}}" class="btn">{{__('Register')}}</a></p>
                    </div>
                </div>
            </div>
        </div>
